...
A set of R scripts used for data collection, data cleaning and analyses and required dataset are provided.
...
3.  Download additional data that are publicly accessible: (i) [Australian Frog Atlas](https://zenodo.org/doi/10.5281/zenodo.5493513) and (ii) [Australia's bioregions (IBRA)](https://fed.dcceew.gov.au/maps/a5a9a356105b4a728d0606194d8bdf38)
4.  Rename the [Australian Frog Atlas](https://zenodo.org/doi/10.5281/zenodo.5493513) folder as `australian_frog_atlas_frogid`
5.  Rename the [Australia's bioregions (IBRA)](https://fed.dcceew.gov.au/maps/a5a9a356105b4a728d0606194d8bdf38) folder as `IBRA7_regions` and rename all files as `ibra_regions`
...
4.  [`IBRA7_regions`](https://fed.dcceew.gov.au/maps/a5a9a356105b4a728d0606194d8bdf38) is the [Australia's bioregions (IBRA)](https://fed.dcceew.gov.au/maps/a5a9a356105b4a728d0606194d8bdf38)
...
Due to the exclusion or generalisation of sensitive species data from FrogID, some results presented in the manuscript may not be exactly reproducible with the data provided. However, results produced should not vary greatly from those presented in the paper.

## References to methods and datasets

-   Atlas of Living Australia. (2023). Occurrence records download on 2023-10-09. <https://doi.org/10.26197/ala.fb7754b9-f084-4ee3-b4ab-a87dd313d467>; <https://doi.org/10.26197/ala.1e0ded65-7fa5-439f-8298-081537b871a7>; <https://doi.org/10.26197/ala.abd60ea2-f837-4f21-afdc-a5d41340c820>; <https://doi.org/10.26197/ala.d14ae6e3-c8b6-4d7a-bb75-3dbe25e9a753>; <https://doi.org/10.26197/ala.42348355-ed0e-40ac-853f-98fa30a2d5ac>
-   Atlas of Living Australia. (2024). Retrieved 10 October from <https://www.ala.org.au/>
-   Australian Faunal Directory. (2023). Retrieved 14 June from <https://biodiversity.org.au/afd/home>
